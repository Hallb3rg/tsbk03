// 2012 MicroGlut prototype for Linux
// Only tested for GL2 due to my installation being old.
// 1302: Now also tested under GL3, works fine!
...
static void checktimers()
{
	if (gTimers != NULL)
	{
		TimerRec *t, *firethis = NULL, *thisprev;
